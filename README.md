...
This is a fork of the original Audrey II firmware to run on the electrosmith Patch_SM ( one branch on the patch.init() and another one on my custom carrier board).
